...
- (void)cancelOnRequestThread
{
    ...
    [self setHeadersReceivedBlock:nil];
    [self setCompletionBlock:nil];
    [self setFailedBlock:nil];
    [self setBytesReceivedBlock:nil];
    [self setBytesSentBlock:nil];
    [self setDownloadSizeIncrementedBlock:nil];
    [self setUploadSizeIncrementedBlock:nil];
    [self setDataReceivedBlock:nil];
    [self setAuthenticationNeeded:(ASIAuthenticationState)nil];
    [self setProxyAuthenticationNeededBlock:nil];
	[self setRequestRedirectedBlock:nil];
#endif
...
//		if (userAgentHeader) {
//			[self addRequestHeader:@"User-Agent" value:[NSString stringWithFormat:@"yexiao/%@",PD_EDITIONID]];
//		}
		if (acceptHeader) {
